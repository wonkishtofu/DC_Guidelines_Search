...
the guidelines and requirements for conversion of an existing property to a backpackers' hostel which may allowed on a temporary planning permission.
...
Areas where new hotel developments and backpacker's hostels are not
allowed can be found [here](https://intranet.ura.gov.sg/-/media/Corporate/Guidelines/Development-control/Circulars/2018/Jun/dc18-04/dc18-04-AppA.pdf?la=en) (PDF,
12.9 MB).
