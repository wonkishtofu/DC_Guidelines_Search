...
## Transport Facilities: Advisory Notes
...
## Transport Facilities: Guidelines at a Glance: Transport
...
## Transport Facilities: Introduction
...
## Transport Facilities: Petrol Station Developments
...
## Transport Facilities: Gross Plot Ratio (GPR)

The maximum GPR is 0.5.

## Transport Facilities: Building Height

The allowable number of storeys is 1 (maximum).

## Transport Facilities: Site Coverage

The maximum site coverage is 50%.

## Transport Facilities: Road Buffer and Common Boundary Setback

Petrol stations shall be set back from the road and common boundary as
indicated below:
From the line of Road Reserve (All road categories): Minimum 7.5m (3m green buffer, 4.5m physical)
From common boundary: Minimum 4.5m (including 2m planting strip)
   
## Transport Facilities: Road Reserve: The plot of land to be vested in the State as
...
## Transport Facilities: Use Quantum
...
## Transport Facilities: Strata Subdivision

Strata subdivision is not allowed.


## Transport Facilities: Gross Plot Ratio
...
## Transport Facilities: Drainage Reserve (DR): An area safeguarded for purposes of
...
## Transport Facilities: Building Setback from Boundary
...
^1^ ## Transport Facilities: Road Reserve: The plot of land to be vested in the State as
required under the Street Works Act. It is demarcated by the line of
Road Reserve in the Road Line Plan and the site boundary.

## Transport Facilities: Road Buffer by Category
Category 1: 15m or 5m (inclusive of Green Buffer)
Category 2: 7.5m or 3m (inclusive of Green Buffer)
Category 3: 5m or 3m (inclusive of Green Buffer)
Category 4 & 5: 5m 3m (inclusive of Green Buffer)

## Transport Facilities: Building Setback Requirement
Common boundary with other developments   Minimum 4.5m (including 2m planting strip)


## Transport Facilities: Building Feature
...
## Transport Facilities: Basements
...
## Transport Facilities: Basement Setback
...
## Transport Facilities: Visual Screening
...
^1^ ## Transport Facilities: Window: Raised openings that are at least 0.9m above the floor
...
## Transport Facilities: Roof Screening
...
## Transport Facilities: Street Block Plans
...
## Transport Facilities: Street Block
...
## Transport Facilities: Developments Involving Waterbodies
...
## Transport Facilities: Design Guidelines

1.  ## Transport Facilities: Retaining Walls
...
2.  ## Transport Facilities: Boundary Walls/Fences
...
4.  ## Transport Facilities: Conservation of Vegetation

> Mature vegetation along the waterbodies are to be saved and conserved,
> wherever possible.

## Transport Facilities: Development Application Submission Guidelines
...
## Transport Facilities: Application of Guidelines
...
## Transport Facilities: Ancillary Structures
...
## Transport Facilities: Setback and Height Control for Ancillary Structures

   
  ## Transport Facilities: Type of Ancillary Structures**   **Required Setback from the Road**                                                                           **Required Setback from the Other Boundaries**   **Height Control
...
## Transport Facilities: Car and Motor-Cycle Parking
...
## Transport Facilities: Range-based Car Parking Standards (RPPS)
...
## Transport Facilities: Bicycle Parking
...
## Transport Facilities: Diesel and Petrol Pump Points
...
## Transport Facilities: RC Flat Roofs
...
## Solar Panels
https://intranet.ura.gov.sg/Corporate/Guidelines/Development-Control/Non-Residential/Transport/RC-Flat-Roofs#Solar-Panels)
...
## Transport Facilities: Planning Permission
...
## Elevated solar panels^2^ located in developments on the following
...
## Transport Facilities: Spaces under solar panels are enclosed or put to commercial use
...
## Transport Facilities: Assessment of Storey Height
...
## Transport Facilities: Guidelines for Elevated Solar Panels

  ## Transport Facilities: Parameter**   **Guidelines
   
  Extent          Within the 45-degree line from the springing line of the roof level
  Height          Maximum 5m above roof level


## Transport Facilities: Earthworks
...
## Transport Facilities: Earthworks within the building setback area
...
## Transport Facilities: Earthworks within the entire development site
...
## Transport Facilities: Minimum Platform Level (MPL): The minimum 1^st^ storey level to
