...
## Agriculture: Agriculture- Advisory Notes
...
## Agriculture: Agriculture- Guidelines at a Glance
...
## Agriculture: Agriculture- Minimum Building Setback from Common Boundary
...
## Agriculture: Agriculture- Minimum Road Buffer
...
## Agriculture: Agriculture- Building Height
...
## Agriculture: Agriculture- Allowable Uses
...
## Agriculture: Agriculture- Earthworks
...
## Agriculture: Agriculture- Boundary and Retaining Walls
...
## Agriculture: Agriculture- Introduction
...
## Agriculture: Agriculture- Building Setback from Boundary
...
^1^ ## Agriculture: Agriculture- Road Reserve: The plot of land to be vested in the State as
...
## Agriculture: Agriculture- Table 1: Road Buffer, Green Buffer


  ## Agriculture: Agriculture- Road Category**   Road Buffer\
                      (inclusive of Green Buffer indicated in brackets)**
...
## Agriculture: Agriculture- Table 2: Common Boundary Setback & Planting Strip

  ## Agriculture: Agriculture- Type of Boundary##                                                                         Minimum Building Setback Requirement

  Along common boundaries with non-agriculture developments, drainage reserve and backlanes   4.5m (including 2m planting strip)
  Along common boundaries with other agriculture developments                                 2m (no planting strip required)

## Agriculture: Agriculture- Table 3: Setback for Building Appendages

  ## Agriculture: Agriculture- Building Feature##                                        **Within Road Buffer**                            Within Setback from Common Boundaries
...
## Agriculture: Agriculture- Overall Building Height
...
## Agriculture: Agriculture- Ancillary Structures
...
## Agriculture: Agriculture- Parking
...
## Agriculture: Agriculture- Earthworks within the build-able area (ie outside the building setback area)

Earthworks within the build-able area of more than 1.5m are subject to
evaluation depending on merits.

## Agriculture: Agriculture- Earthworks within the entire development site
...
^1^ ## Agriculture: Agriculture- Minimum Platform Level (MPL): The minimum 1^st^ storey level to
be provided within the site. The MPL is determined by the Public
Utilities Board (PUB).

## Agriculture: Agriculture- Retaining & Boundary Walls
...
## Agriculture: Agriculture- Plan Application Process for Land Leased or Sold by the State for Agriculture Use
...
## Agriculture: Agriculture- Criteria for the Agriculture Plan Lodgment Scheme
...
## Agriculture: Agriculture- Other requirements:
...
## Agriculture: Agriculture- Land Tenanted Out or Granted Temporary Occupation Licence by the State for Agriculture Use Other requirements:
...
## Agriculture: Agriculture- Summary of Plan Application Processes for Land Sold, Leased, or Tenanted by the State for Agriculture Use##  Other requirements:
